...
window.APP_CONFIG = {
    ...
    OPENROUTER_MULTIMODAL_SECONDARY_MODEL: window.ENV?.OPENROUTER_MULTIMODAL_SECONDARY_MODEL || "google/gemini-2.0-flash-lite-001",
    OPENROUTER_MULTIMODAL_TERTIARY_MODEL: window.ENV?.OPENROUTER_MULTIMODAL_TERTIARY_MODEL || "google/gemini-flash-1.5",
